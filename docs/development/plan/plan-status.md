...
| [`plan-20260912.md`](plan-20260912.md) | B（memory boundary） | 进行中 | MB-01..MB-04 `done/complete`（v0.23.37 / v0.23.39 / v0.23.40 / v0.23.41，D 门全绿）；MB-05、MB-07/08、MB-10/11 `pending`；MB-06/09/12 已取消（`done`） |
