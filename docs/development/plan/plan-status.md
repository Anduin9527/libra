...
| [`plan-20260912.md`](plan-20260912.md) | B（memory boundary） | 进行中 | MB-01..MB-05 `done/complete`（v0.23.37 / v0.23.39 / v0.23.40 / v0.23.41 / v0.23.42，D 门全绿）；MB-07 `in-progress`（v0.23.43 已 bump；DEP-MB-04 pin 重核通過；EX-MB-02 門 1–11 exact 全綠、transport 6/6、rg 零命中、fmt/clippy；待全量 nextest + push/release/D 门）；MB-08、MB-10/11 `pending`；MB-06/09/12 已取消（`done`） |
