...
| [`plan-20260912.md`](plan-20260912.md) | B（memory boundary） | 进行中 | MB-01、MB-02 `done/complete`（v0.23.37 / v0.23.39，D 门全绿）；MB-03 `in-progress`（v0.23.40 已 bump；A/B 组绿：lib 10、CLI 9、matrix 9、help banner、docs grep、fmt/clippy；backend `cf` docs 已推送 cc42991/e1d0999；待全量 nextest + push/release/D 门）；MB-04/05、MB-07/08、MB-10/11 `pending`；MB-06/09/12 已取消（`done`） |
