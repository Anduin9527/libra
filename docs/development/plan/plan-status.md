...
| [`plan-20260912.md`](plan-20260912.md) | B（memory boundary） | 进行中 | MB-01 `done/complete`（v0.23.37，D 门全绿）；MB-02 `in-progress`（v0.23.39 已 bump；A 组 7+2+guard 全绿、ER-14 全量 7742 passed/0 failed；forward-fix：windows `HANDLE` 导入修正并以 msvc target 探针验证；待 push/release/D 门）；MB-03..05、MB-07/08/10/11 `pending`；MB-06/09/12 已取消（`done`） |
