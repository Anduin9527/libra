...
| `fts5_capability_test` | 1 | M2-02F release-linked SQLite capability proof: external-content FTS5 create/insert, parameter-bound MATCH, fixed weighted BM25 ASC semantics, and unicode61 diacritic behavior | `src/internal/ai/memory/fts_sql.rs`, `sql/migrations/2026082502_memory_fts_search.sql` |
